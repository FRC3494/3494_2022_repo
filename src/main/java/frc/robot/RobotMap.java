...
public class RobotMap {
    ...
    public static class Shooter {
        ...
        public static final int HOOD_MOTOR_CHANNEL = 5;
    ...
    public static class Intake {
        ...
        public static final int FRONT_INTAKE_DEPLOY_MOTOR_CHANNEL = 9;
        public static final int BACK_INTAKE_DEPLOY_MOTOR_CHANNEL = 10;
    }

    public static class Magazine {
        public static final int LEFT_TREE_MOTOR_CHANNEL = 11;
        public static final int LEFT_TREE_LINEBREAK_CHANNEL = 0;

        public static final int RIGHT_TREE_MOTOR_CHANNEL = 12;
        public static final int RIGHT_TREE_LINEBREAK_CHANNEL = 1;

        public static final int TREE_STEM_MOTOR_CHANNEL = 13;
